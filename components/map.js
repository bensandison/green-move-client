...
export default function Mapbox({ longitude, latitude, startingZoom, allPlaces, showAll }) {
	...
	useEffect(() => {
		...
		// 	//gets data for all cities
		// 	const res = await fetch("https://api.greenmove.tk/places/all");
